...
def get_config(project = '', mode = '', config_ = '', data = '', LRS = '', batch_size = 8):
    ...
    config.data_offset = '/ssd/1/yrz/Dataset/GoPro_INR' #zzh: root path
...
def set_train_path(config, data):
    ...
    elif data == 'nah': # zzh: data path here
        config.data_path = config.data_offset
        config.input_path = 'GoPro_train_blur_gamma_ratio_5_steps_20000_dec'
        config.gt_path = 'GoPro_train_sharp_resized_cropped'

        config.VAL.data_path = config.data_offset
        config.VAL.input_path = 'GoPro_test_blur_gamma_ratio_5_steps_20000_dec'
        config.VAL.gt_path = 'GoPro_test_sharp_resized_cropped'
...
def set_eval_path(config, data):
    if data == 'DVD':
        ...
        config.EVAL.data_path = config.data_offset
        config.EVAL.input_path = 'GoPro_test_blur_gamma_ratio_5_steps_20000_dec' # os.path.join(config.VAL.data_path, 'input')
        config.EVAL.gt_path = 'GoPro_test_sharp_resized_cropped' # os.path.join(config.VAL.data_path, 'gt')
    elif data == 'random':
